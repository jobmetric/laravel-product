...
use JobMetric\Product\Models\ProductInterfaceService;

/**
 * @extends Factory<ProductInterfaceService>
 */
class ProductInterfaceServiceFactory extends Factory
{
    protected $model = ProductInterfaceService::class;
